...
cust_id = db.add_customer({"name": "Test User Scenario Customer", "phone": "9999999999", "address": "Test Address"})
...
# Now save a bill of total 200, previous udhaar is 50, but user only pays 100.
# So udhaar_adjustment = 50.0, amount_paid = 100.0, payment_mode = "Credit (Udhaar)"
bill_data = {
    "customer_id": cust_id,
    "customer_name": "Test User Scenario Customer",
    "subtotal": 200.0,
    "discount": 0.0,
    "grand_total": 200.0,
...
# Assertions
assert cust["credit_balance"] == 150.0, f"Expected 150.0 credit_balance, got {cust['credit_balance']}"

# Test Void
print("\nVoiding the bill...")
void_ok = db.void_bill(bill_id, "Void user scenario", 1)
...
print("\nUser scenario verification complete (Save & Void passed)!")
